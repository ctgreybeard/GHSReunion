...
#nav ul li a {color:<?php echo $menulink ?>;}
#nav ul li.active a,#nav ul li:hover a{color:<?php echo $menulinkhover ?>; background-color:<?php echo $menubghover ?>  }
...
#nav ul li.active ul li a,
#nav ul li ul li.active ul li a { color:<?php echo $menulink ?>; background-color:<?php echo $menubg ?> }
#nav ul li ul li a:hover,
#nav ul li ul li.active a,
#nav ul li.active ul li a:hover,
#nav ul li li ul li a:hover,
#nav ul li ul li.active ul li.active a,
#nav ul li ul li.active a, #nav ul li.active ul li a:hover{color:<?php echo $menulinkhover ?>; background-color:<?php echo $menubghover ?>  }
